...
const ReportLostItem = () => {
  ...
  return (
    <section id="report-lost" className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-4 rounded-full bg-accent/10 border border-accent/20">
            ...
            <span className="text-sm font-medium text-accent">Report a Lost Item</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">Lost Something?</h2>
